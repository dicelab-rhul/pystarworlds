...
phy = GridPhysics({VisionSensor:[VisionPerception,GridVisionPerception,VWGridVisionPerception,VWActionResultPerception], CommunicationSensor:[VWCommunicationPerception]})
